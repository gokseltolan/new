...
/**
 * <p>Java class for getMeasureListResponse complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="measureTypes" type="{http://ws.soap.assignment.introsde/}measureTypes" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetMeasureListResponse {
    ...
    protected List<MeasureTypes> measureTypes;
     ...
     * 
     */
    public List<MeasureTypes> getMeasureTypes() {
        if (measureTypes == null) {
            measureTypes = new ArrayList<MeasureTypes>();
        }
