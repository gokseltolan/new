 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.soap.assignment.introsde/", wsdlLocation = "http://10.218.206.53:3100/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.218.206.53:3100/ws/people?wsdl");
